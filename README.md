...
- **Pluggable agents.** Claude Code, the OpenAI Codex CLI, and the Cursor CLI today, more agents soon — adapter packages translate AIR config into agent-specific formats.
...
| **Agent Adapters** | `AgentAdapter` | None | `@pulsemcp/air-adapter-claude`, `@pulsemcp/air-adapter-codex`, `@pulsemcp/air-adapter-cursor` |
